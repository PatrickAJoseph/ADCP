...
#define ADCP_RX_QUEUE_SIZE        					5UL
#define ADCP_TX_QUEUE_SIZE        					5UL
...
#define ADCP_N_FRAMES							    (uint8_t)3
...
extern int8_t ADCP_Transmit_Queue_Element_Count;                   //  Receive Queue front pointer.
extern int8_t ADCP_Receive_Queue_Element_Count;
